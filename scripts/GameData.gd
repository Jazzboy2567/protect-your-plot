...
# aura ("heal"/"haste"/"cleanse"), beast (Hunter bonus), plague_immune,
# applies_plague/applies_burn/applies_slow (on-hit), knockback, bonus_beast, behavior.
...
const UNITS := {
	...
	"herbalist":  {"id":"herbalist","name":"Herbalist","hp":30,"damage":3,"range":7,"cooldown":1.3,"speed":52,"radius":8,"cost":35,"aura":"cleanse","aura_range":90,"plague_immune":true,"color":Color(0.55,0.80,0.70)},
	...
	"rat":         {"id":"rat","name":"Plague Rat","hp":12,"damage":3,"range":5,"cooldown":0.7,"speed":72,"radius":5,"drop":2,"beast":true,"applies_plague":true,"color":Color(0.55,0.30,0.35)},
	...
	"ram":         {"id":"ram","name":"Ram","hp":58,"damage":12,"range":8,"cooldown":1.3,"speed":85,"radius":10,"drop":9,"armor":2,"beast":true,"knockback":14,"color":Color(0.85,0.55,0.30)},
	"wolf":        {"id":"wolf","name":"Wolf","hp":30,"damage":8,"range":6,"cooldown":0.8,"speed":110,"radius":7,"drop":7,"beast":true,"behavior":"diver","color":Color(0.60,0.45,0.45)},
	...
	"plague_risen":{"id":"plague_risen","name":"Plague-Risen","hp":70,"damage":8,"range":7,"cooldown":1.2,"speed":30,"radius":10,"drop":14,"applies_plague":true,"plague_immune":true,"color":Color(0.45,0.55,0.35)},
	...
	"black_death": {"id":"black_death","name":"The Black Death","hp":650,"damage":26,"range":13,"cooldown":1.1,"speed":30,"radius":22,"drop":70,"armor":8,"applies_plague":true,"plague_immune":true,"color":Color(0.50,0.10,0.35)},
}
