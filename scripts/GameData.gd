...
const UNITS := {
	...
	"woodcutter": {"id":"woodcutter","name":"Woodcutter","hp":65,"damage":15,"range":9,"cooldown":1.4,"speed":45,"radius":9,"cost":35,"color":Color(0.72,0.62,0.50)},
	...
	"bandit":      {"id":"bandit","name":"Bandit","hp":36,"damage":7,"range":7,"cooldown":1.0,"speed":55,"radius":8,"drop":6,"color":Color(0.80,0.35,0.30)},
	"ram":         {"id":"ram","name":"Ram","hp":58,"damage":12,"range":8,"cooldown":1.3,"speed":85,"radius":10,"drop":9,"color":Color(0.85,0.55,0.30)},
	"knight":      {"id":"knight","name":"Knight","hp":130,"damage":18,"range":9,"cooldown":1.3,"speed":40,"radius":11,"drop":22,"color":Color(0.85,0.25,0.25)},
	"black_death": {"id":"black_death","name":"The Black Death","hp":650,"damage":26,"range":13,"cooldown":1.1,"speed":30,"radius":22,"drop":70,"color":Color(0.50,0.10,0.35)},
}
